...
Polynomial pointwise_mul_ntt(const Polynomial& a, const Polynomial& b) {
    ...
    pointwise_mul_one_prime<COEFF_MODULI[1], PSM_C[1], false>(a.residues[1].data(), b.residues[1].data(), out.residues[1].data());
    pointwise_mul_one_prime<COEFF_MODULI[2], PSM_C[2], false>(a.residues[2].data(), b.residues[2].data(), out.residues[2].data());
    pointwise_mul_one_prime<COEFF_MODULI[3], PSM_C[3], true >(a.residues[3].data(), b.residues[3].data(), out.residues[3].data());
    return out;
}
